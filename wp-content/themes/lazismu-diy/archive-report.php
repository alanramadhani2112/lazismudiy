...
<main class="container-site py-12">
	<header class="max-w-3xl">
		<p class="text-sm font-semibold uppercase tracking-wide text-brand-orange"><?php esc_html_e( 'Transparansi', 'lazismu-diy' ); ?></p>
	...
	<div class="mt-8 grid gap-6 md:grid-cols-3">
		<?php if ( have_posts() ) : ?>
			...
			<?php endwhile; ?>
		<?php else : ?>
			<p><?php esc_html_e( 'Belum ada laporan.', 'lazismu-diy' ); ?></p>
		<?php endif; ?>
	</div>
